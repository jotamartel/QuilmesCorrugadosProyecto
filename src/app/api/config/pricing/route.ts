...
export async function POST(request: NextRequest) {
  try {
    ...
    const numericFields = [
      ...
      'price_per_m2_retail',
      'printing_min_m2',
      'printing_included_min_m2',
      'printing_surcharge_per_color',
    ...
    const { data: config, error } = await supabase
      ...
      .insert({
        ...
        printing_min_m2: body.printing_min_m2 ?? 1000,
        printing_included_min_m2: body.printing_included_min_m2 ?? 3000,
        printing_surcharge_per_color: body.printing_surcharge_per_color ?? 0.15,
