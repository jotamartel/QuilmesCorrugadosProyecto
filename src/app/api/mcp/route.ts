...
// Versiones y herramientas viven en lib/mcp/definicion: también las leen los
// manifests de descubrimiento de /.well-known/ y con dos copias la que se
// olvida de actualizar miente.
import { VERSIONES, VERSION_POR_DEFECTO, HERRAMIENTAS } from '@/lib/mcp/definicion';
  ...
  return NextResponse.json(
    {
      ...
      // Los manifests de descubrimiento estándar, para clientes que los buscan.
      discovery: {
        server_card: `${SITE_URL}/.well-known/mcp.json`,
